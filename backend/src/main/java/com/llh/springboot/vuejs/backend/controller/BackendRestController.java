...
import com.llh.springboot.vuejs.backend.repository.UserRepository;
...
public class BackendRestController {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(BackendRestController.class);
    ...
    public User getUserById(@PathVariable("id") long id) throws Exception {
        ...
        return userRepository.findById(id).map(user -> {
            ...
            return user;
        }).orElseThrow(() -> new Exception("The user with the id " + id + " couldn't be found in the database."));
    }
